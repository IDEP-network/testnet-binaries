...
```
sudo docker run --name node -e moniker='Your_moniker' -e chain='Your_Chain' -e api='your_api_token' -p 26656-26657:26656-26657 -p 1317:1317 -itd idepnetwork/testnet-denali
